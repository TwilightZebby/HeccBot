...
module.exports = {
    ...
    async execute(buttonInteraction)
    {
        ...
        let heccbotBlocklist = require('../../JsonFiles/Hidden/ServerBlocklist.json');
        ...
        .then(async LeftGuild => {
            // Add to Block List
            heccbotBlocklist["blocklist"].push(`${LeftGuild.id}`);
            fs.writeFile('./JsonFiles/Hidden/ServerBlocklist.json', JSON.stringify(heccbotBlocklist, null, 4), async err => {
