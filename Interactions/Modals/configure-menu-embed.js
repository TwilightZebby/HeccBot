...
module.exports = {
    ...
    // Modal's Description
    Description: `Handles input for Role Menu Embed data during configuration`,
    ...
    async execute(modalInteraction)
    {
        ...
        let menuEmbed = Collections.RoleMenuConfiguration.get(modalInteraction.guildId)?.embed;
        ...
        // Update stored Embed
        let fetchedData = Collections.RoleMenuConfiguration.get(modalInteraction.guildId);
        fetchedData.embed = menuEmbed;
        Collections.RoleMenuConfiguration.set(modalInteraction.guildId, fetchedData);
