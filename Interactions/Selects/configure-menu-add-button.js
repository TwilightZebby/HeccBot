...
module.exports = {
    ...
    Description: `Handles Role Select for adding a Role to a Menu during configuration (Button Type)`,
    ...
    async execute(selectInteraction)
    {
        ...
        const MenuButtonModal = new ModalBuilder().setCustomId(`configure-menu-button-text_${RoleID}_${ButtonType}`).setTitle(localize(selectInteraction.locale, 'ROLE_MENU_SET_BUTTON_LABEL')).addComponents([
