...
module.exports = {
    ...
    Description: `Handles Role Select for adding a Role to a Menu during creation (Role ID)`,
    ...
    async execute(selectInteraction)
    {
        ...
        const ButtonTypeSelect = new ActionRowBuilder().addComponents([
            new StringSelectMenuBuilder().setCustomId(`create-menu-add-button_${InputRole.id}`).setMinValues(1).setMaxValues(1).setPlaceholder(localize(selectInteraction.locale, 'ROLE_MENU_SELECT_BUTTON_COLOR')).setOptions([
